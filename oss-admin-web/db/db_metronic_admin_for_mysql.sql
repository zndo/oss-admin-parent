...
CREATE TABLE `ADMIN_USER` (
    ...
    `USER_STATUS` TINYINT (2) NOT NULL DEFAULT 0 COMMENT '用户状态：-1-已禁用/0-未激活/1-已激活/2-已锁定',
...
CREATE TABLE `ADMIN_ROLE` (
    ...
    `ROLE_STATUS` TINYINT (1) NOT NULL DEFAULT 1 COMMENT '角色状态：0-禁用/1-正常',
    `CREATED` DATETIME NOT NULL COMMENT '创建时间',
    `UPDATED` DATETIME NOT NULL NOT NULL COMMENT '更新时间',
    `DELETED` TINYINT (1) NOT NULL DEFAULT 0 NULL COMMENT '是否删除：0-未删除/1-已删除',
    PRIMARY KEY (`ID`),
...
CREATE TABLE `ADMIN_AUTHORITY` (
    ...
    `AUTHORITY_STATUS` TINYINT (1) NOT NULL DEFAULT 1 COMMENT '权限状态：0-禁用/1-正常',
    `CREATED` DATETIME NOT NULL COMMENT '创建时间',
    `UPDATED` DATETIME NOT NULL NOT NULL COMMENT '更新时间',
    `DELETED` TINYINT (1) NOT NULL DEFAULT 0 NULL COMMENT '是否删除：0-未删除/1-已删除',
    PRIMARY KEY (`ID`),
...
CREATE TABLE `ADMIN_RESOURCE` (
    ...
    `RESOURCE_STATUS` TINYINT (1) NOT NULL DEFAULT 1 COMMENT '资源状态：0-禁用/1-正常',
    `CREATED` DATETIME NOT NULL COMMENT '创建时间',
    `UPDATED` DATETIME NOT NULL NOT NULL COMMENT '更新时间',
    `DELETED` TINYINT (1) NOT NULL DEFAULT 0 NULL COMMENT '是否删除：0-未删除/1-已删除',
    PRIMARY KEY (`ID`),
...
CREATE TABLE `ADMIN_USER_ROLE` (
    ...
    `RLAT_STATUS` TINYINT (1) NOT NULL DEFAULT 1 COMMENT '关系状态：0-禁用/1-正常',
    `CREATED` DATETIME NOT NULL COMMENT '创建时间',
    `UPDATED` DATETIME NOT NULL NOT NULL COMMENT '更新时间',
    `DELETED` TINYINT (1) NOT NULL DEFAULT 0 NULL COMMENT '是否删除：0-未删除/1-已删除',
    PRIMARY KEY (`ID`)
...
CREATE TABLE `ADMIN_MODULE` (
    ...
    `PRIORITY` INT DEFAULT NULL COMMENT '优先级',
    `MODULE_STATUS` TINYINT (1) NOT NULL DEFAULT 1 COMMENT '模块状态：0-禁用/1-正常',
    `CREATED` DATETIME NOT NULL COMMENT '创建时间',
    `UPDATED` DATETIME NOT NULL NOT NULL COMMENT '更新时间',
    `DELETED` TINYINT (1) NOT NULL DEFAULT 0 NULL COMMENT '是否删除：0-未删除/1-已删除',
    PRIMARY KEY (`ID`),
